<template>
    <div class="max-w-5xl m-auto">
        ...
        <button class="block mx-auto my-10 w-max p-4 bg-green-450 rounded-xl shadow-md shadow-gray-500 font-arial font-bold text-white text-2xl text-center">Envoyer un message</button>

        <div class="w-full p-5 flex justify-end gap-5">
            <button class="flex-none w-max p-3 bg-white border-2 border-red-550 rounded-xl shadow-md shadow-gray-300 font-arial font-bold text-red-550 text-lg text-center">
                Signaler
            </button>
            <button class="flex-none w-max p-3 bg-white border-2 border-black rounded-xl shadow-md shadow-gray-300 font-arial font-bold text-lg text-center">
                Bloquer
            </button>
        </div>
