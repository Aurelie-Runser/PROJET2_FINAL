...
<label class="block mt-10 pl-2 pr-2">
  ...
  <input type="search" name="searchbar" class="mt-1 px-3 py-2
   bg-white border shadow-sm border-slate-300
    placeholder-slate-400 focus:outline-none focus:border-green-500  focus:ring-green-500 block w-full rounded-xl sm:text-sm focus:ring-1" 
...
<div class="grid mt-10 grid-cols-1">
    ...
    <FriendsHL1  image="/public/images/Nathanael.png" txt="Christopher Mccandless "/>
</div>      
